ALTER TABLE `#__newsworld` ADD COLUMN `description` VARCHAR(4000) NOT NULL DEFAULT '' AFTER `greeting`;

INSERT INTO `#__content_types` (`type_title`, `type_alias`, `rules`, `field_mappings`, `content_history_options`) 
VALUES
('Newsworld', 'com_newsworld.newsworld', '', '',
'{"formFile":"administrator\\/components\\/com_newsworld\\/models\\/forms\\/newsworld.xml", 
...
{"sourceColumn":"parent_id","targetTable":"#__newsworld","targetColumn":"id","displayColumn":"greeting"},
{"sourceColumn":"catid","targetTable":"#__categories","targetColumn":"id","displayColumn":"title"}]}'),
('Newsworld Category', 'com_newsworld.category', '', '',
