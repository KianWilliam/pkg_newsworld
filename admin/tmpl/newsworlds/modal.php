<?php
/**
 * Layout file for the admin modal display of newsworld records
 *
 */
...
$function  = $app->input->getCmd('function', 'jSelectNewsworld');
$onclick   = $this->escape($function);
?>
<div class="container-popup">
    
<form action="<?php echo Route::_('index.php?option=com_newsworld&view=newsworlds&layout=modal&tmpl=component&' . Session::getFormToken() . '=1'); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
    ...
    <div class="clearfix"></div>
        ...
        <table class="table table-striped table-hover">
            <thead>
            <tr>
                <th width="3%"><?php echo Text::_('COM_NEWSWORLD_NUM'); ?></th>
                <th width="15%">
                ...
                <?php if (!empty($this->items)) : ?>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <?php 
                                $link = 'index.php?option=com_newsworld&view=newsworld&id=' . $row->id;
